      ...
      <div className="flex flex-col justify-start px-3 py-3 text-sm border-b border-neutral-800">
        <div className="flex justify-between items-center">
          ...
          <TooltipButton placement="top" content="Leave call">
            <button className="p-2 hover:bg-neutral-800 rounded-md">
        ...
        <div className="flex justify-evenly items-center pt-2 gap-2">
          <div className="group relative w-full">
            <button className="bg-neutral-800 hover:bg-neutral-800/75 px-3 py-2 rounded-md w-full flex items-center justify-center">
      ...
      <div className="flex items-center justify-between w-full px-2 py-3 text-xs text-neutral-400">
        <div className="flex gap-2 items-center justify-center">
          <div className="relative flex-shrink-0">
            ...
            />
            <div className="absolute -bottom-0 -right-0 w-[10px] h-[10px] rounded-full bg-green-500 ring-2 ring-neutral-950 border-neutral-950"></div>
          </div>
        ...
        <div className="flex items-center gap-1">
          <TooltipButton placement="top" content="Turn off microphone">
            <button className="p-1.5 hover:bg-neutral-800 transition-colors rounded-md">
