  ...
  return (
    ...
    <div className="flex flex-col items-center space-y-3">
      <div className="group w-16 flex items-center justify-between pr-2">
        <div className="w-1 h-0 group-hover:h-4 rounded-r-md opacity-0 group-hover:opacity-100 bg-white transition-all duration-300"></div>
      ...
      <div className="w-14 h-[2px] bg-gray-700 rounded-full"></div>
    </div>
    <div className="group relative w-12 h-12 bg-gray-700 hover:bg-green-500 rounded-full flex items-center justify-center text-green-500 hover:text-white cursor-pointer transform hover:rounded-2xl transition-all duration-100 ease-in-out hover:scale-105 z-[99999]">
